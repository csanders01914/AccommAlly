...
export async function POST(request: NextRequest) {
 ...
 const { caseId, type, subtype, description, isLongTerm, startDate, endDate, decisionLogic } = validation.data;
 ...
 decisionLogic: decisionLogic || null,
