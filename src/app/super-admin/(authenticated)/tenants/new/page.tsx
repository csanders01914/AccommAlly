        ...
        <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
                <Link
                    ...
                    className="text-sm text-slate-400 hover:text-white transition-colors flex items-center gap-1 mb-4"
                >
                ...
                <p className="text-slate-400 mt-1">Set up a new workspace for an organization</p>
            </div>
                    ...
                    <div className="grid gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-slate-900/50 border border-slate-600/50 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-transparent transition-all"
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 bg-slate-900/50 border border-slate-600/50 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-transparent transition-all"
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-3 bg-slate-900/50 border border-slate-600/50 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-transparent transition-all"
                            >
