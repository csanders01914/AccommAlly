...
export default function EditTenantPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 {error && (
 <div className="bg-red-100 border border-red-500/20 text-red-500 p-4 rounded-lg mb-6">
 {error}
 </div>
 )}
 ...
 className="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-2 text-slate-900 focus:ring-2 focus:ring-violet-500 focus:border-transparent outline-none"
 />
 </div>
 ...
 type="submit"
 disabled={saving}
 className="px-6 py-2 bg-violet-600 hover:bg-violet-700 text-slate-900 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
 >
