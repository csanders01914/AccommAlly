    ...
    if (error || !tenant) {
        return (
            <div className="text-center py-12">
                ...
                <p className="text-slate-400 mb-4">{error || 'Tenant not found'}</p>
    ...
    return (
        <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-400 text-sm">{tenant.plan} Plan</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <div className="flex items-center gap-2 text-slate-300 font-mono text-sm bg-slate-900/50 p-2 rounded">
                ...
                <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 md:col-span-2">
                ...
                <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 md:col-span-2">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-lg font-semibold text-white">Letter Templates</h2>
        ...
        <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
                ...
                <div className="text-xs">
                    ...
                    <div className="text-slate-300 font-mono">{primaryColor}</div>
                </div>
            </div>
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="text-xs">
                    ...
                    <div className="text-slate-300 font-mono">{secondaryColor}</div>
                </div>
            </div>
