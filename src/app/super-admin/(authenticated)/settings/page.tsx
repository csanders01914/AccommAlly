...
export default function SuperAdminSettingsPage() {
 ...
 <span className="font-mono text-sm text-slate-600 border border-slate-600 px-3 py-2 rounded-md bg-white">{value}</span>
 </div>
 ...
 <p className="text-slate-500 mt-1">Manage branding and appearance for each tenant.</p>
 </div>
 ...
 className="w-full bg-slate-800 border border-slate-600 text-slate-900 rounded-lg px-4 py-2.5 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-violet-500"
 >
 ...
 <div className="space-y-8 bg-white border border-slate-200 rounded-2xl p-8">
 ...
 {/* Brand Colors */}
 <div>
 <h2 className="text-base font-semibold text-slate-900 mb-4">Brand Colors</h2>
 ...
 {/* Sidebar */}
 <div>
 <h2 className="text-base font-semibold text-slate-900 mb-4">Sidebar Appearance</h2>
 <div className="grid md:grid-cols-2 gap-6">
 ...
 {/* Page Background */}
 <div>
 <h2 className="text-base font-semibold text-slate-900 mb-4">Page Background</h2>
 <div className="flex items-center gap-2 mb-4">
 {(['solid', 'gradient'] as const).map(mode => (
 <button key={mode} onClick={() => setPageBackgroundMode(mode)}
 className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-all capitalize ${pageBackgroundMode === mode ? 'bg-violet-600 text-slate-900' : 'bg-slate-700 text-slate-600 hover:bg-slate-600'}`}>
 {mode}
 </button>
 ))}
 </div>
 ...
 className="bg-slate-800 border border-slate-600 text-slate-900 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-500">
 ...
 {/* Logo */}
 <div>
 <h2 className="text-base font-semibold text-slate-900 mb-4">Logo</h2>
 ...
 <label className="cursor-pointer flex items-center gap-2 px-4 py-2 bg-slate-700 hover:bg-slate-600 text-slate-700 rounded-lg text-sm transition-colors">
 ...
 className="flex items-center gap-2 px-6 py-2.5 bg-violet-600 hover:bg-violet-500 disabled:opacity-50 text-slate-900 font-medium rounded-lg transition-colors">
