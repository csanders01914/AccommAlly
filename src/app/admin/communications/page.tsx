    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button
                    onClick={fetchData}
                    className="p-2 bg-[#ffffff] border border-[#E5E2DB] rounded-lg hover:bg-[#F8F7F5] text-[#5C5850] transition-colors"
                >
            ...
            {/* Tabs */}
            <div className="flex space-x-1 bg-[#F8F7F5] p-1 rounded-lg w-fit border border-[#E5E2DB]">
                <button
                ...
                {loading && messages.length === 0 && rtcs.length === 0 ? (
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm">
                            ...
                            <tbody className="divide-y divide-[#F3F1EC]">
                                {messages.map(msg => (
                                    <tr key={msg.id} className="hover:bg-[#F8F7F5] transition-colors">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm">
                            ...
                            <tbody className="divide-y divide-[#F3F1EC]">
                                {rtcs.map(rtc => (
                                    <tr key={rtc.id} className="hover:bg-[#F8F7F5] transition-colors">
                                        <td className="px-6 py-4">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            {rtc.type === 'TASK' ? (
                                                ...
                                                <button
                                                    disabled
                                                    className="text-[#8C8880] text-xs font-medium border border-[#E5E2DB] bg-[#F8F7F5] px-3 py-1.5 rounded-lg cursor-not-allowed"
