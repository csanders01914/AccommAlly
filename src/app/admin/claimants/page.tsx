        ...
        <div className="min-h-screen font-sans p-8">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Claimant Management</h1>
                        <p className="text-gray-500 dark:text-gray-400">Manage claimant identities and credentials</p>
                    </div>
                    <button
                            ...
                            <table className="w-full text-left text-sm">
                                <thead className="bg-white/20 dark:bg-gray-800/50 border-b border-white/10 dark:border-gray-700/30">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 font-semibold text-gray-700 dark:text-gray-300">Verification</th>
                                        <th className="px-6 py-4 font-semibold text-gray-700 dark:text-gray-300">Cases</th>
