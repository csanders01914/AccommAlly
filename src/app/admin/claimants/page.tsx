                ...
                <div className="bg-[#ffffff] rounded-xl border border-[#E5E2DB] p-4">
                    <div className="relative max-w-md">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 rounded-lg border border-[#E5E2DB] bg-[#F8F7F5] text-[#1C1A17] placeholder-[#8C8880] focus:outline-none focus:ring-2 focus:ring-[#0D9488]/30 focus:border-[#0D9488] transition-colors"
                            value={search}
                            ...
                            <table className="w-full text-left text-sm">
                                ...
                                <tbody className="divide-y divide-[#F3F1EC]">
                                    {claimants.map((c) => (
                                        <tr
                                            key={c.id}
                                            className="hover:bg-[#F8F7F5] transition-colors cursor-pointer"
