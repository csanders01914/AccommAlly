...
export default function ClaimantProfilePage() {
 ...
 <button
 onClick={() => router.back()}
 className="mt-4 px-4 py-2 text-primary-500 hover:bg-primary-50 rounded-lg transition-colors"
 >
 Go Back
 </button>
 </div>
 ...
 <button
 onClick={() => router.back()}
 className="p-2 hover:bg-surface-raised dark:hover:bg-gray-800 rounded-lg transition-colors"
 >
 ...
 {isAdmin && (
 <button className="px-4 py-2 text-sm font-medium text-white bg-primary-500 hover:bg-primary-600 rounded-lg transition-colors flex items-center gap-2">
 ...
 className="p-4 border border-border rounded-lg hover:bg-surface-raised dark:hover:bg-gray-800 cursor-pointer transition-colors"
 >
 ...
 {c.claimFamily && (
 <span className="flex items-center gap-1 px-2 py-0.5 text-xs font-medium rounded-full bg-primary-100 text-primary-700">
 ...
 <div className="text-right text-xs text-text-muted ml-4">
