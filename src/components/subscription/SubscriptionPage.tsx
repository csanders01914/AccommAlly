...
export function SubscriptionPage({ currentUserId }: SubscriptionPageProps) {
 ...
 style={{ border: '1px solid #E5E2DB', color: '#5C5850', backgroundColor: '#FAF6EE' }}
 onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.backgroundColor = '#F3F1EC'; }}
 onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.backgroundColor = '#FAF6EE'; }}
 >
 ...
 onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.backgroundColor = '#FAF6EE'; }}
 onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'transparent'; }}
 >
 Downgrade
 </button>
