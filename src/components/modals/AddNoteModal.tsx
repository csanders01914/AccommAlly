...
export function AddNoteModal({
 ...
 <div className="md:col-span-2 bg-[#FAF6EE] p-4 rounded-lg border border-[#E5E2DB] flex items-center justify-between">
 <div>
 ...
 {selectedFile ? (
 <div className="flex items-center gap-3 p-3 bg-[#FAF6EE] border border-[#E5E2DB] rounded-lg">
 ...
 <label className="flex items-center gap-2 px-4 py-3 border-2 border-dashed border-[#E5E2DB] rounded-lg cursor-pointer hover:border-[#0D9488]/40 hover:bg-[#FAF6EE] transition-colors">
