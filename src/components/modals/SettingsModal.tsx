                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-3 py-2.5 text-sm border border-[#E5E2DB] rounded-lg bg-[#F8F7F5] text-[#1C1A17] placeholder-[#8C8880] h-32 resize-none focus:outline-none focus:ring-2 focus:ring-[#0D9488]/30 focus:border-[#0D9488] transition-colors"
                                />
                    ...
                    {activeTab === 'rules' && (
                        <div className="space-y-5">
                            ...
                            {isLoadingRules ? (
                                ...
                                <div className="text-center py-8 bg-[#F8F7F5] rounded-xl border border-dashed border-[#E5E2DB]">
                                    ...
                                    {rules.map(rule => (
                                        <div key={rule.id} className="border border-[#E5E2DB] rounded-lg overflow-hidden">
                                            ...
                                            {expandedRule === rule.id && (
                                                <div className="px-3 pb-3 bg-[#F8F7F5] text-xs text-[#8C8880] grid grid-cols-2 gap-2 border-t border-[#E5E2DB]">
                                        ...
                                        <button key={theme} onClick={() => savePreferences({ ...prefs, display: { ...prefs.display, theme } })}
                                            className={cn('p-3 rounded-lg border text-center transition-all',
                                                (prefs.display?.theme || 'system') === theme
                                                    ...
                                                    : 'border-[#E5E2DB] text-[#5C5850] hover:border-[#0D9488]/30 hover:bg-[#F8F7F5]'
                                            )}>
                                        ...
                                        <button key={density} onClick={() => savePreferences({ ...prefs, display: { ...prefs.display, density } })}
                                            className={cn('p-3 rounded-lg border text-left transition-all',
                                                (prefs.display?.density || 'comfortable') === density
                                                    ...
                                                    : 'border-[#E5E2DB] hover:border-[#0D9488]/30 hover:bg-[#F8F7F5]'
                                            )}>
