                ...
                <div className="p-6">
                    {success ? (
                        ...
                        <form onSubmit={handleVerify} className="space-y-4">
                            ...
                            <input
                                type="password"
                                className="w-full px-4 py-3 text-center text-lg tracking-widest rounded-lg border border-[#E5E2DB] bg-[#F8F7F5] text-[#1C1A17] focus:outline-none focus:ring-2 focus:ring-[#0D9488]/30 focus:border-[#0D9488] transition-colors placeholder:text-sm placeholder:tracking-normal"
