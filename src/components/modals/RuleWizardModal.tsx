        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="bg-[#ffffff] rounded-xl shadow-[0_8px_40px_rgba(28,26,23,0.18)] border border-[#E5E2DB] w-full max-w-2xl h-[600px] flex flex-col relative overflow-hidden">
                ...
                <div className="flex-1 flex flex-col min-h-0">
                    <div className="flex-1 overflow-y-auto p-5 border-b border-[#E5E2DB] bg-[#F8F7F5]">
                        {step === 1 && (
                    ...
                    <div className="h-40 p-4 bg-[#ffffff] overflow-y-auto border-b border-[#E5E2DB]">
                        ...
                        <div className="p-3 border border-[#E5E2DB] rounded-lg text-sm text-[#5C5850] leading-relaxed bg-[#F8F7F5]">
                ...
                <div className="px-6 py-4 border-t border-[#E5E2DB] bg-[#F8F7F5] flex justify-between items-center">
                        ...
                        <div className="bg-[#ffffff] rounded-xl shadow-[0_8px_40px_rgba(28,26,23,0.18)] border border-[#E5E2DB] p-5 w-80">
                            ...
                            {editMode.type === 'folder' && (
                                <div className="space-y-1 mb-4 max-h-40 overflow-y-auto">
                                    {folders.map(f => (
                                        <label key={f.id} className="flex items-center gap-2.5 px-2 py-1.5 hover:bg-[#F8F7F5] rounded-lg cursor-pointer text-sm text-[#5C5850]">
