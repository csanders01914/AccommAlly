    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="bg-[#ffffff] rounded-xl shadow-[0_8px_40px_rgba(28,26,23,0.18)] border border-[#E5E2DB] w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
                                ...
                                {suggestions.map(suggestion => {
                                    ...
                                    return (
                                        <div key={suggestion.id} onClick={() => toggleSelection(suggestion.id)}
                                            className={cn('flex items-start gap-3 p-3 rounded-xl border cursor-pointer transition-all', isSelected ? 'bg-[#0D9488]/8 border-[#0D9488]/30' : 'bg-[#ffffff] border-[#E5E2DB] hover:border-[#0D9488]/30 hover:bg-[#F8F7F5]')}>
                ...
                <div className="flex justify-end gap-3 px-6 py-4 border-t border-[#E5E2DB] bg-[#F8F7F5]">
