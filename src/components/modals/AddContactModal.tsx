...
const iconInputCls = 'form-input pl-9 pr-3';
...
export function AddContactModal({ isOpen, onClose, onSubmit }: AddContactModalProps) {
 ...
 <div className="modal-container w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col" role="dialog" aria-modal="true" aria-labelledby="contact-modal-title">
 <div className="flex items-center justify-between px-6 py-4 border-b border-border">
 <h2 id="contact-modal-title" className="text-base font-semibold text-text-primary flex items-center gap-2">
 <UserPlus className="w-4 h-4 text-primary-500" />
 Add Contact
 </h2>
 <button onClick={onClose} className="p-1.5 hover:bg-surface-raised rounded-lg transition-colors" aria-label="Close modal">
 ...
 <div className="relative">
 <Briefcase className="w-3.5 h-3.5 text-text-muted absolute left-3 top-1/2 -translate-y-1/2" />
 ...
 <div className="relative">
 <Users className="w-3.5 h-3.5 text-text-muted absolute left-3 top-1/2 -translate-y-1/2" />
 ...
 <div className="relative">
 <MapPin className="w-3.5 h-3.5 text-text-muted absolute left-3 top-2.5" />
 ...
 <div className="relative">
 <FileText className="w-3.5 h-3.5 text-text-muted absolute left-3 top-2.5" />
 ...
 <button onClick={onClose} className="px-4 py-2 text-sm font-medium text-text-secondary bg-surface border border-border rounded-lg hover:bg-surface-raised transition-colors">
 Cancel
 </button>
 <button onClick={handleSubmit} disabled={!name.trim() || !role.trim()} className="flex items-center gap-2 px-5 py-2 text-sm font-semibold text-white bg-primary-500 hover:bg-primary-600 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
