        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-xl text-gray-900 dark:text-white">AccommAlly</span>
                        </div>
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
                    {/* Table Header */}
                    <div className="hidden md:grid md:grid-cols-12 gap-4 px-6 py-3 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  ...
                  `}
                                >
                                    ...
                                    <div className="md:col-span-2 flex items-center gap-2">
                                        <Calendar className={`w-4 h-4 ${isOverdue(task) ? 'text-red-500' : 'text-gray-400'}`} />
