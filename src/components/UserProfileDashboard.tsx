...
function TasksCard({ tasks }: { tasks: DashTask[] }) {
 ...
 >
 {/* Table header */}
 <div className="grid grid-cols-[140px_180px_1fr_16px] gap-4 px-5 py-2.5 bg-[#FAF6EE] border-b border-[#E5E2DB] text-[10px] font-semibold uppercase tracking-[0.12em] text-[#8C8880]">
 <div>Due</div>
 <div>Claim #</div>
 <div>Description</div>
 <div />
 ...
 className={`grid grid-cols-[140px_180px_1fr_16px] gap-4 px-5 py-3.5 border-b border-[#F3F1EC] items-center transition-colors last:border-b-0 ${over ? 'bg-[rgba(254,242,242,0.45)] hover:bg-[rgba(254,242,242,0.7)]' : 'bg-[#ffffff] hover:bg-[#FAF6EE]'}`}
 >
...
function RecentCasesCard({ cases }: { cases: DashCase[] }) {
 ...
 key={c.id}
 href={`/cases/${c.id}`}
 className="flex items-center justify-between px-5 py-3.5 border-b border-[#F3F1EC] hover:bg-[#FAF6EE] transition-colors last:border-b-0"
 >
 <div className="min-w-0">
...
function MessagesCard({ messages }: { messages: DashMessage[] }) {
 ...
 key={m.id}
 href="/messages"
 className="flex gap-3 px-4 py-3 border-b border-[#F3F1EC] hover:bg-[#FAF6EE] transition-colors last:border-b-0"
 >
 <div
