...
import { Shield, FolderOpen, MessageSquare, ClipboardCheck } from 'lucide-react';
...
export function AboutPage() {
 ...
 {/* Hero */}
 <section className="py-24 px-8 text-center" style={{ backgroundColor: '#FAF6EE' }}>
 <h1
 ...
 {/* How it works */}
 <section className="py-24 px-8" style={{ backgroundColor: '#FAF6EE' }}>
 <div className="max-w-4xl mx-auto">
 <h2
